...
import { DataTableFacetedFilterProps } from "./data-table/data-table-faceted-filter";
import { DataTablePagination } from "./data-table/data-table-pagination";
import { DataTableToolbar } from "./data-table/data-table-toolbar";

import { Icons } from "@wealthfolio/ui";
import { Table, TableBody, TableCell, TableRow } from "@wealthfolio/ui";
...
export function TableViewer({ name, data, fileType, className, maxHeight = "400px" }: TableViewerProps) {
  ...
  ] satisfies DataTableFacetedFilterProps<TableRow, string>[];
    ...
    <div className={cn("space-y-2", className)}>
      ...
      <div className="overflow-hidden rounded-md border">
        ...
        <div className="border-border bg-muted flex items-center justify-between border-b px-3 py-2">
          <span className="text-muted-foreground text-xs">{headerBarTitle}</span>
          <span className="text-muted-foreground text-xs">
