...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@wealthfolio/ui";
...
export const AccountSelector = forwardRef<HTMLButtonElement, AccountSelectorProps>(
  (
    ...
    const allAccounts = Object.entries(accountsByType);
            ...
            <CommandList>
              {isLoading ? (
                ...
                <>
                  ...
                  {allAccounts.map(([type, typeAccounts]) => (
